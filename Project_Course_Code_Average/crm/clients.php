...
//if search then calculate total page for that search result
    ...
    $query="select count(id) as totalPages,max(autoIncrement) as maxAutoInc from tushantMarketing_clients where (name like '%$search%' or contactNo like '%$search%' or email like '%$search%'  or code like '%$search%') and paymentStatus='$paymentStatus' ";
...
if((!isset($_GET['page'])) || (isset($_GET['lastEntryNo']))){
    ...
    if($searchEnabled)
        $query="select * from tushantMarketing_clients where autoIncrement > $lastEntryNo and paymentStatus='$paymentStatus' and (name like '%$search%' or contactNo like '%$search%' or email like '%$search%'  or code like '%$search%') order by autoIncrement asc limit 10";
}
    ...
    if($searchEnabled)
        $query="select * from tushantMarketing_clients where autoIncrement < $firstEntryNo and paymentStatus='$paymentStatus' and (name like '%$search%' or contactNo like '%$search%' or email like '%$search%'  or code like '%$search%') order by autoIncrement desc limit 10";
}
